...
int SMO_getTimes(SMO_Handle p_handle, SMO_time code, int *time)
//
...
int SMO_getNodeSeries(SMO_Handle p_handle, int nodeIndex,
...
int SMO_getLinkSeries(SMO_Handle p_handle, int linkIndex,
...
int SMO_getSubcatchAttribute(SMO_Handle p_handle, int periodIndex,
...
int SMO_getNodeAttribute(SMO_Handle p_handle, int periodIndex,
...
int SMO_getLinkAttribute(SMO_Handle p_handle, int periodIndex,
...
int SMO_getSubcatchResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_getNodeResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_getLinkResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_getSystemResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_bufferSubcatchResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_bufferNodeResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_bufferLinkResult(SMO_Handle p_handle, int periodIndex,
...
int SMO_bufferSystemResult(SMO_Handle p_handle, int periodIndex,
